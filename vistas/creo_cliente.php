...
<html>
   ...
   <!-- <form action="../controladores/insertar.php" method="POST">   -->
        ...
        <div class="container">  
            ...
            <div class="col-lg-6 col-sm-6 col-md-6">
                <label>Ingrese Celular Cliente:</label>
            ...
            <div class="col-lg-6 col-sm-6 col-md-6">   
                <label>Ingrese Email Cliente:</label> 
