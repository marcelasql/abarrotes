...
<html>
   ...
   include("../controladores/seguridad.php");?>
    <!--<form action="../controladores/insertar.php" method="POST">-->
        ...
        <br><h2>AYUDA PROVEEDOR</h2><br>
        </center>

<div class="container">  
    <div class="row"> 
  <div class="panel">
      <div class="panel panel-heading">MANTENEDOR PROVEEDOR</div>
            <div class="panel-body"><br>
                            
                <p class="card-text">
                    El Mantenedor de Proveedor tiene como objetivo, insertar,
                    consultar, modificar y eliminar proveedores. 

                    Los datos requeridos son:<br>
                    Codigo : debe ser único.<br><br>
                    Nombre : Descrición del proveedor.<br><br>
                    Rut : Rut del proveedor.<br><br>
                    Dirección : Dirección del proveedor<br><br>
                    Teléfono : Teléfono del proveedor   <br><br>
                    <!--Botones: <br>-->
                    <h6 style="color:green">Botones</h6>
                    Guardar Proveedor : Permite registrar las datos ingresados en pantalla.<br>
